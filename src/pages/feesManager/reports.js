...
//                     ₹{((reportData.totalEarning ?? 0) + (reportData.totalPending ?? 0)).toLocaleString()}
//                   </Typography>
//                 </Box>
//                 <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
//                   <Typography>Total Collected:</Typography>
//                   <Typography fontWeight="bold" color="success.main">
//                     ₹{(reportData.totalEarning ?? 0).toLocaleString()}
//                   </Typography>
//                 </Box>
//                 <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
//                   <Typography>Total Pending:</Typography>
//                   <Typography fontWeight="bold" color="warning.main">
//                     ₹{(reportData.totalPending ?? 0).toLocaleString()}
//                   </Typography>
//                 </Box>
//                 <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
//                   <Typography>Growth from Previous Year:</Typography>
//                   <Typography fontWeight="bold" color={(reportData.growth ?? 0) >= 0 ? "success.main" : "error.main"}>
//                     {reportData.growth >= 0 ? '+' : ''}{(reportData.growth ?? 0).toLocaleString()}%
//                   </Typography>
//                 </Box>
//               </CardContent>
//             </Card>
...
//                     {((reportData.totalEarning ?? 0) / ((reportData.totalEarning ?? 0) + (reportData.totalPending ?? 0)) * 100).toFixed(1)}%
//                   </Typography>
//                 </Box>
