...
// import ExamScheduleCalendar from '../../../components/admin/ExamScheduleCalendar';
// import Button from '../../../components/ui/Button';
// import ExamSubjectFormModal from '../../../components/admin/ExamSubjectFormModal';
...
//       try {
//         setLoading(true);
//         const [examRes, scheduleRes, roomsRes] = await Promise.all([
//           AdminService.getExamEvent(id),
//           AdminService.getExamSchedulesForEvent(id),
//           AdminService.getAvailableRooms()
//         ]);
        
//         setExamEvent(examRes.data);
//         setSchedule(scheduleRes.data.schedule || []);
//         setAvailableRooms(roomsRes.data || []);
        
//         // Fetch subjects for all classes in the exam event
//         if (examRes.data.classes?.length) {
//           const subjectsPromises = examRes.data.classes.map(cls => 
//             AdminService.getSubjectsByClass(cls._id)
//           );
...
//     try {
//       const response = await AdminService.createExamSchedule({
//         examEventId: id,
//         ...subjectData
//       });
...
//             </Button>
//             <Button 
//               onClick={() => router.push(`/admin/exams/${examEvent._id}/seating`)}
//               variant="secondary"
//             >
//               Generate Seating
//             </Button>
...
//             <span className="font-medium">Exam Type:</span> {examEvent.examType === 'Other' ? examEvent.customExamType : examEvent.examType}
//           </p>
//           <p className="text-gray-600">
//             <span className="font-medium">Dates:</span> {new Date(examEvent.startDate).toLocaleDateString()} - {new Date(examEvent.endDate).toLocaleDateString()}
//           </p>
//           {examEvent.nonWorkingDays?.length > 0 && (
//             <p className="text-gray-600">
//               <span className="font-medium">Non-working Days:</span> {examEvent.nonWorkingDays.map(d => new Date(d).toLocaleDateString()).join(', ')}
//             </p>
//           )}
//         </div>

//         <ExamScheduleCalendar schedule={schedule} />
